...
function BirthdayTitle({ name, startDateTime }) {
  ...
  return (
    <div className="birthday-container">
      ...
      <CountdownTimer targetDate={playtimeEnd} color="#EB4781" timerName="Play Time" endText={`Kids can no longer play`} earlyText={`Not Started please wait for party host`} earlyCutoff={ 60 } />
